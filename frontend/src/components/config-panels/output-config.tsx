    ...
    <div className="space-y-6">
      <div className="space-y-3">
        <div className="flex items-center gap-2 px-0.5">
          ...
          <Label htmlFor="aspect_ratio" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/50">Aspect Ratio</Label>
        </div>
        <div className="relative group">
          <select
            id="aspect_ratio"
            className="flex h-10 w-full rounded-[20px] border border-border/80 dark:border-white/10 bg-muted/20 dark:bg-white/5 px-4 py-2 text-sm focus:border-primary/40 focus:bg-muted/30 outline-none appearance-none transition-all pr-10"
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2 px-0.5">
          ...
          <Label htmlFor="num_images" className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/50">Number of Images</Label>
        </div>
        <Input
          id="num_images"
          type="number"
          min={1}
          max={4}
          className="bg-muted/20 dark:bg-white/5 border-border/80 dark:border-white/10 focus:bg-muted/30 focus:border-primary/40 transition-all rounded-[20px] h-10 px-4 text-sm"
